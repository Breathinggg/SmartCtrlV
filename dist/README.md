...
File name list (with extension)	Create multiple empty files (auto-rename on conflicts)
Folder name list (no extension)	Create folders (v1.1+)
...
**v1.1** (2025-01-16)
- Pasting names without extension now creates **folders** instead of extensionless files
- Folder name length limit: 100 characters
